...
<main class="main">
                        ...
                        <div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="images/slider/slide-1-480w.jpg">
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="images/slider/slide-2-480w.jpg">
                ...
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="common/product.html">
                                <img src="images/products/product-1.jpg" alt="Product image" class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="common/product.html">GoPro - HERO7 Black HD Waterproof Action</a></h3><!-- End .product-title -->
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="common/product.html">
                                <img src="images/products/product-2.jpg" alt="Product image" class="product-image">
                                <img src="images/products/product-2-2.jpg" alt="Product image" class="product-image-hover">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="common/product.html">Apple - Apple Watch Series 3 with White Sport Band</a></h3><!-- End .product-title -->
                            <div class="product-price">
                                $214.99
                            </div><!-- End .product-price -->
                            <div class="ratings-container">
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="common/product.html">
                                <img src="images/products/product-3.jpg" alt="Product image" class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="common/product.html">Lenovo - 330-15IKBR 15.6"</a></h3><!-- End .product-title -->
                            <div class="product-price">
                    ...
                    <div class="product product-2">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="common/product.html">Sony - Alpha a5100 Mirrorless Camera</a></h3><!-- End .product-title -->
                            <div class="product-price">
                                $499.99
                            </div><!-- End .product-price -->
                            <div class="ratings-container">
    ...
    <div class="container">
        <div class="cta cta-border cta-border-image mb-5 mb-lg-7" style="background-image: url(images/bg-1.jpg);">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 deal-col">
                    <div class="deal" style="background-image: url('images/deal/bg-1.jpg');">
                        <div class="deal-top">
                        ...
                        <div class="deal-content">
                            <h3 class="product-title"><a href="common/product.html">Home Smart Speaker with Google Assistant</a></h3><!-- End .product-title -->
                            ...
                            <a href="common/product.html" class="btn btn-link"><span>Shop Now</span><i class="icon-long-arrow-right"></i></a>
                            ...
                            <div class="col-6">
                                <div class="product product-2">
                                    <figure class="product-media">
                                        ...
                                        <a href="common/product.html">
                                            <img src="images/products/product-5.jpg" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="common/product.html">Canon - EOS 5D Mark IV DSLR Camera</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                            ...
                            <div class="col-6">
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="common/product.html">Apple - Smart Keyboard Folio for 11-inch iPad Pro</a></h3><!-- End .product-title -->
                                        <div class="product-price">
    ...
    <div class="container">
        <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl"
            ...
            <a href="#" class="brand">
                <img src="common/images/brands/1.png" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="common/images/brands/2.png" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="common/images/brands/3.png" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="common/images/brands/4.png" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="common/images/brands/5.png" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="common/images/brands/6.png" alt="Brand Name">
            </a>
        </div><!-- End .owl-carousel -->
    </div><!-- End .container -->
    ...
    <div class="container trending">
        ...
        <div class="row">
            <div class="col-xl-5col d-none d-xl-block">
                <div class="banner">
                    <a href="#">
                        <img src="images/banners/banner-4.jpg" alt="banner">
                    </a>
                </div><!-- End .banner -->
            </div><!-- End .col-xl-5col -->
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Bose - SoundSport wireless headphones</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $199.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="common/product.html">
                                        <img src="images/products/product-8.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Microsoft - Refurbish Xbox One S 500GB</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $279.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-new">New</span>
                                    <a href="common/product.html">
                                        <img src="images/products/product-9.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Apple Watch Series 4 Gold Aluminum Case</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $499.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Sony - Class LED 2160p Smart 4K Ultra HD</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-top">Top</span>
                                    <a href="common/product.html">
                                        <img src="images/products/product-15.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Samsung - 55" Class LED 2160p Smart</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $899.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">MacBook Pro 13" Display, i5</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $1,199.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-new">New</span>
                                    <a href="common/product.html">
                                        <img src="images/products/product-13.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Apple - 11 Inch iPad Pro with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $899.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="common/product.html">
                                        <img src="images/products/product-12.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Bose - SoundLink Bluetooth Speaker</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $79.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <span class="product-label label-circle label-sale">Sale</span>
                                    <a href="common/product.html">
                                        <img src="images/products/product-14.jpg" alt="Product image" class="product-image">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="common/product.html">Google - Pixel 3 XL 128GB</a></h3><!-- End .product-title -->
                                    <div class="product-price">
    ...
    <div class="container">
        <div class="cta cta-separator cta-border-image cta-half mb-0" style="background-image: url(images/bg-2.jpg);">
            <div class="cta-border-wrapper bg-white">
                <div class="row">
                    <div class="col-lg-6">
